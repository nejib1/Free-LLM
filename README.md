...
| [Api.Airforce](https://api.airforce/) | No | 1 RPM | 1,000 requests/day | Free tier: $0/month, no credit card | See provider |
<!--TABLE:PERMANENT:END-->
...
| [Api.Airforce](https://api.airforce/) | `https://api.airforce/v1` | [Get Key →](https://api.airforce/) |
<!--TABLE:QUICKREF:END-->
