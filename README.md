...
- **Damascus** — point your `damascus.toml` roles at any free provider for verified, sandboxed code. See [`code-examples/damascus.md`](code-examples/damascus.md)
...
**By coding assistant:** [Claude Code](code-examples/claude-code.md) · [Cursor](code-examples/cursor.md) · [Codex CLI](code-examples/codex.md) · [Damascus](code-examples/damascus.md)
...
<p align="center"><sub>Data synced automatically from the live directory — last updated: <!--LASTSYNC:START-->2026-09-21<!--LASTSYNC:END--></sub></p>
